        ...
        <Row>
          <Col lg={2} className={styles.sidebar}>
            <Nav variant="pills" className={`flex-column ${styles.adminNav}`}>
              <Nav.Item>
                <Nav.Link 
                  className={`${styles.navLink} ${activeTab === 'dashboard' ? 'active' : ''}`}
              ...
              <Nav.Item>
                <Nav.Link 
                  className={`${styles.navLink} ${activeTab === 'users' ? 'active' : ''}`}
              ...
              <Nav.Item>
                <Nav.Link 
                  className={`${styles.navLink} ${activeTab === 'boards' ? 'active' : ''}`}
              ...
              <Nav.Item>
                <Nav.Link 
                  className={`${styles.navLink} ${activeTab === 'site' ? 'active' : ''}`}
              ...
              <Nav.Item>
                <Nav.Link 
                  className={`${styles.navLink} ${activeTab === 'statistics' ? 'active' : ''}`}
